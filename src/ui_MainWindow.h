...
public:
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        roomLabel->setText(QCoreApplication::translate("MainWindow", "Room:", nullptr));
